...
>Напишите команду: ***git add*** пробел ***<Имя файла>***

## *Создание коммитов*:

Для того, чтобы создать коммит(сохранение) необходимо выполнить команду ***\*git commit\****. Выполняется она так:
>Напишите команду: ***git commit*** пробел ***-m*** пробел ***<сообщение к коммиту>***
...
>***git checkout*** пробел ***<номер коммита>

Для ввода номера коммита достаточно первых четырёх знаков.

## *Возврат в последнее соханённое состояние для продолжения работы* :
...
>***git branch*** пробел ***<название новой ветки>***

## *Слияние веток* :

Для того чтобы дабавить ветку в текущую ветку используется команда :

>***it merge*** пробел ***<name branc\>***

## *Удаление веток* :

Для удаления ветки ввести команду:

>***git branch*** пробел  ***-d'name branch'***

***
***
***

И в заключении хотелось бы добавить, что все команды, то , как я оформил этот текст, каждом знаке выше изложенного - заслуга моих преподавателей!!! Это [Ильнар Шафигуллин](https://gb.ru/users/teachers/3546003 "Преподаватель GeekBrains") человек умеющий ***"красиво разложить"*** и ***"грамитно преподать"***. И [Софья Главацкая](https://gb.ru/users/teachers/7524512 "Преподаватель GeekBrains")-покарившая своей добратой, умением слушать, терпением в помощи нам, задающим иногда глуппые вопросы, студентам [GeekBrains](https://gb.ru "IT-образование")
